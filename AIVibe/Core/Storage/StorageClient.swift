...
// Модуль: Core/Storage
// Протокол клиента хранения и реализация на UserDefaults + файловая система.
//
// NOTE: @unchecked Sendable — StorageClient хранит только thread-safe объекты
// (UserDefaults, FileManager, URL), критические секции не требуются.

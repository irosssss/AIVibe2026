...
(function () {
  ...
  const db = {
    ...
    projects: [
      ...
      { id: "p_kirova", name: "Кирова 17к1", room: "3 комнаты · 87,59 м²", style: "По дизайн-проекту", area: 88, items: 44, budget: 2700000, updated: "2025-01-30", cover: "living", status: "В работе" },
    ],
